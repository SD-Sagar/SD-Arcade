      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 neon-border bg-transparent text-white rounded-lg font-bold hover:bg-[#bc13fe] transition-all disabled:opacity-50"
          >
        ...
        <p className="mt-6 text-center text-gray-400 text-sm">
          ...
          <Link href="/register" className="text-[#00f3ff] hover:underline">
            Register here
          </Link>
        </p>
      </motion.div>
